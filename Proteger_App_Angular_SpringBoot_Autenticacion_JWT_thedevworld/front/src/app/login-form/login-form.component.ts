...
/**
Tener la solicitud de inicio de sesión en el componente principal, permite manejar la rta
y cambiar del formulario de inicio de sesión al componente de contenido de autenticación
una vez autenticado
    -> auth-component
 content-component
    -> login-component
