...
CREATE TABLE IF NOT EXISTS public.persona (
  ...
  estado_id int REFERENCES public.estado(id),
  pais_id int REFERENCES public.pais(id)
);

-- Insertar datos persona
INSERT INTO public.persona(apellido, edad, nombre_completo, estado_id, pais_id) VALUES ('Vera', 30, 'Lucho', 1, 1);
...
-- Ingresar paises
INSERT INTO public.pais(id, paisnombre) VALUES
(1, 'Australia'),
(2, 'Austria'),
(3, 'Azerbaiyán'),
(4, 'Anguilla'),
...
-- INGRESAR DATOS ESTADO
INSERT INTO public.estado(id, pais_id, estadonombre) VALUES
(1, 3, 'Azerbaijan'),
